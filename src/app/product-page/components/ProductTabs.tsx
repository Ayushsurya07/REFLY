...
const reviews = [
  {
    ...
    rating: 5,
    date: 'Dec 2025',
    text: 'Absolutely premium quality. The Japanese denim feels incredible and the slim cut is perfect for my build. Worth every rupee.',
    verified: true,
    size: 'W32',
  },
  {
    ...
    rating: 5,
    date: 'Nov 2025',
    text: "Best jeans I've bought from an Indian brand. The finish is impeccable and delivery was super fast.",
    verified: true,
    size: 'W34',
  },
  {
    ...
    rating: 4,
    date: 'Nov 2025',
    text: "Great quality and fit. Runs slightly slim so size up if you're between sizes. The color is richer than the photos.",
    verified: true,
    size: 'W34',
  },
  {
    ...
    rating: 5,
    date: 'Oct 2025',
    text: 'Refly has changed my perception of Indian fashion. These jeans are on par with international luxury brands.',
    verified: true,
    size: 'W32',
  },
];
  ...
  return (
    <div className="flex gap-0.5">
      {[1, 2, 3, 4, 5].map((s) => (
        <svg
          key={s}
          className={`w-3.5 h-3.5 ${s <= rating ? 'star-filled' : 'star-empty'}`}
          fill="currentColor"
          viewBox="0 0 24 24"
        >
    ...
    <div className="max-w-[1600px] mx-auto px-6 lg:px-12 py-12 border-t border-border">
        ...
        <div className="max-w-3xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="p-6 border border-border">
              <h3 className="font-display font-bold text-sm tracking-widest uppercase mb-4">
                Features
              </h3>
      ...
      {activeTab === 'Fabric & Care' && (
        <div className="max-w-3xl grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            <h3 className="font-display font-bold text-sm tracking-widest uppercase mb-6">
              Fabric Composition
            </h3>
              ...
              {[
                {
                  ...
                  detail: product.shipping.standardDays,
                  price: 'FREE above ₹999',
                },
                {
                  label: 'Express Delivery',
                  detail: product.shipping.expressDays,
                  price: `₹${product.shipping.expressPrice}`,
                },
                {
                  label: 'Cash on Delivery',
                  detail: 'All cities in India',
                  price: `+₹${product.shipping.codCharge}`,
                },
                {
                  label: 'Order Tracking',
                  detail: 'Real-time updates via SMS/WhatsApp',
                  price: 'Included',
                },
              ].map((item) => (
              ...
              <div key={review.id} className="p-6 border border-border">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="text-right">
                    ...
                    <p className="font-display text-xs font-semibold text-gold mt-1">
                      Size: {review.size}
                    </p>
                  </div>
                </div>
