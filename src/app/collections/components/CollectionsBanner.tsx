...
const bannerData: Record<Category, { title: string; subtitle: string; image: string; imageAlt: string; }> = {
  all: {
    ...
    imageAlt: 'Men\'s fashion editorial — dark cinematic studio, dramatic shadows, low-key atmospheric lighting, premium clothing showcase'
  },
  jeans: {
    title: 'Jeans',
    subtitle: 'Japanese denim. Precision cut.',
    image: "https://images.unsplash.com/photo-1734663657543-39f5b21f2b55",
    imageAlt: 'Premium denim jeans close-up — dark moody studio, deep indigo shadows, dramatic texture lighting'
  },
  cargo: {
    title: 'Cargo',
    ...
    imageAlt: 'Cargo pants editorial — dark atmospheric studio, military aesthetic, dramatic shadows'
  },
  formal: {
    title: 'Formal',
    ...
    imageAlt: 'Formal trousers editorial — dark minimalist studio, sharp tailoring, dramatic directional lighting'
  },
  linen: {
    title: 'Linen',
    ...
    imageAlt: 'Linen trousers editorial — bright airy studio, natural light, clean white background, premium fabric detail'
  },
  chinos: {
    title: 'Chinos',
    subtitle: 'Versatile. Sharp. Effortless.',
    image: "https://img.rocket.new/generatedImages/rocket_gen_img_1583d16c0-1772733407074.png",
    imageAlt: 'Chinos editorial — clean minimal studio, well-lit professional photography, premium cotton detail'
  },
  joggers: {
    title: 'Joggers',
    subtitle: 'Engineered for motion.',
    image: "https://img.rocket.new/generatedImages/rocket_gen_img_18347ef41-1772199610019.png",
    imageAlt: 'Joggers editorial — dark athletic studio, dynamic lighting, motion blur, premium sportswear aesthetic'
  },
  shorts: {
    title: 'Shorts',
    subtitle: 'Summer essentials. Zero compromise.',
