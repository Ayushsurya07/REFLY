...
export const metadata: Metadata = {
  ...
  description:
    "Refly crafts premium men's bottom wear — jeans, cargo, formal, linen pants, chinos, joggers and shorts. Luxury quality, delivered across India.",
  keywords: [
    'premium mens jeans india',
    'luxury cargo pants',
    'mens formal pants india',
    'refly clothing',
    'premium bottom wear india',
  ],
  openGraph: {
    ...
    images: [
      {
        url: '/assets/images/6391F31B-6325-43A2-8883-0AEF80565846-1785440876904.png',
        width: 1200,
        height: 630,
        alt: "Refly — Premium Men's Bottom Wear",
      },
    ],
    type: 'website',
    locale: 'en_IN',
