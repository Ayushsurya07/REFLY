  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-16">
      ...
      <p className="mb-8 text-gray-700 leading-8">
        Welcome to <strong>reflystore.in</strong>. By accessing or using our website,
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-8">
          We strive to display our products accurately. How ever, slight
          variations in color or appearance may occur due to screen settings.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-8">
          Refly reserves the right to accept, reject, or cancel any order due
          to stock availability, pricing errors, suspected fraud, or other
          operational reasons.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-8">
          ...
          Refly does not store your card or UPI credentials.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-8">
          ...
          location, courier service, and unforeseen circumstances.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-8">
          Returns and refunds are governed by our Returns Policy. Please review
          that page before requesting a return.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-8">
          ...
          and designs, is the property of Refly and may not be copied or used
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-8">
          Refly shall not be liable for any indirect, incidental, or
