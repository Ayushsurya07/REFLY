        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 reveal-up">
          ...
          <div
            ...
            style={{ transitionDelay: `${i * 80}ms` }}>
              ...
              {/* Quote */}
              <div className="mb-6">
                <svg className="w-8 h-8 text-gold mb-4 opacity-60" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-border">
                ...
                <div className="ml-auto">
                  <span className="font-body text-xs text-muted-foreground">Verified Purchase ✓</span>
                </div>
              </div>
            </div>
          )}
