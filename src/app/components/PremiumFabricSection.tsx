...
const fabrics = [
{
  ...
  weight: '12.5 oz',
  description: 'Woven on vintage shuttle looms producing a tighter, denser weave that develops a unique patina over time.',
  color: '#2C3E50'
},
{
  ...
  origin: 'Biella, Italy',
  weight: '280 GSM',
  description: 'A 4-way stretch fabric with a refined matte finish, engineered for unrestricted movement without sacrificing structure.',
  color: '#34495E'
},
{
  name: 'Belgian Linen',
  ...
  weight: '180 GSM',
  description: 'Stone-washed European flax that softens with each wear while maintaining its characteristic cool drape.',
  color: '#BDC3A7'
}];
...
export default function PremiumFabricSection() {
  ...
  useEffect(() => {
    ...
    sectionRef?.current?.querySelectorAll('.reveal-up, .reveal-left')?.forEach((el) => observer?.observe(el));
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center mb-20 lg:mb-28">
          ...
          <div className="lg:w-5/12 reveal-left">
            ...
            <p className="font-body text-muted-foreground leading-relaxed mb-8 text-base">
              We source from the world&apos;s finest mills — Japanese denim weavers, Italian tailors,
              Belgian linen farmers. Every thread is chosen with the same obsession we apply to the cut.
            </p>
            <div className="space-y-4">
              {['Premium raw materials only', 'Tested for 200+ wash cycles', 'Colorfastness guaranteed', 'Shrink-resistant treatment']?.map((point) =>
          ...
          <div className="lg:w-7/12 reveal-up">
            <div className="relative h-[400px] lg:h-[600px] overflow-hidden">
              ...
              <div className="absolute bottom-8 left-8 glass-dark p-6 luxury-border max-w-[200px]">
                ...
                <p className="font-body text-xs text-white/60 uppercase tracking-widest mt-2">Premium Fabric Sources</p>
              </div>
            </div>
          </div>
        </div>
