        ...
        try {
          ...
          if (!res.ok) {
            ...
            if (
              ...
              setError(
                'Google Sign-In is not enabled on this Supabase project. Please sign in with your email and password.'
              );
    ...
    <div className="w-full max-w-md">
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        <div>
          <label
            htmlFor="login-email"
            className="block font-display text-xs font-semibold tracking-[0.1em] uppercase text-white/60 mb-2"
          >
            Email Address
          </label>
          <input
      ...
      <p className="mt-8 text-center font-body text-sm text-white/40">
        ...
        <Link href="/signup" className="text-white hover:text-gold transition-colors">
          Create one
        </Link>
      </p>
    </div>
